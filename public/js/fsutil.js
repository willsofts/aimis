...
function open_program(appid,url,params,apath,newflag) {
	let fs_newwindows = "1"==$("#accessor_label").data("NEW") || newflag;
	console.log("open_program(appid="+appid+", path="+apath+", url="+url+", params="+params+", new="+fs_newwindows+")");
	let html = false; 
