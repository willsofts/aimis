...
$(function() {
	...
	$("#addforumlinker").click(function() { 
		//window.open("/gui/forumnote/entry","forumnote_info_window"); 
		open_program("forumnote","",null,"/gui/forumnote/entry",true);
	});
...
function buildCategories(categories) {
	...
	for(let cat in categories) {
		...
		link1.click(function() {
			...
			open_program("forumnote","","forumid="+cat,"/gui/forumnote/view",true);
			return false;
		});
		link3.click(function() {
			let cat = $(this).attr("data-cat");
			let title = $(this).attr("data-title");
			open_program("chatnotehistory","","query="+cat+"&title="+title,"/gui/chatnote/view",true);
			return false;
		});
