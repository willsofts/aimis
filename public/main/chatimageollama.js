...
$(function() {
	buildModelers("#modellayer","chatimageollama");
	...
	$("#addforumlinker").click(function() { 
		...
		open_program("forumimage","",null,"/gui/forumdoc/entry",true);
	});
...
function buildModelers(container="#modellayer",category="chatimageollama") {
	let layer = $(container);
	if(model_categories) {
...
function buildCategories(categories) {
	...
	for(let cat in categories) {
		...
		link1.click(function() {
			...
			open_program("forumimage","","forumid="+cat,"/gui/forumdoc/view",true);
			return false;
		});
